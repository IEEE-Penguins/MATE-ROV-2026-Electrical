...
namespace ServoConfig
{
    ...
    // Example test pins
    // -------------------------
    static constexpr uint8_t POSITIONAL_SERVO_TEST_PIN = 32;
    static constexpr uint8_t CONTINUOUS_SERVO_TEST_PIN = 33;
...
{
public:
    explicit ServoBase(uint8_t pin,
